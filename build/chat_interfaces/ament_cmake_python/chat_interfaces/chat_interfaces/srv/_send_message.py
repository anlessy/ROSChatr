...
class Metaclass_SendMessage_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('chat_interfaces')
        except ImportError:
            import logging
            import traceback
...
class SendMessage_Request(metaclass=Metaclass_SendMessage_Request):
    ...
    _fields_and_field_types = {
        'message': 'chat_interfaces/ChatMessage',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['chat_interfaces', 'msg'], 'ChatMessage'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from chat_interfaces.msg import ChatMessage
        self.message = kwargs.get('message', ChatMessage())
    ...
    def message(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'message' field must be a sub message of type 'ChatMessage'"
        self._message = value
...
class Metaclass_SendMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'chat_interfaces.srv.SendMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from chat_interfaces.srv import _send_message
...
class SendMessage(metaclass=Metaclass_SendMessage):
    from chat_interfaces.srv._send_message import SendMessage_Request as Request
    from chat_interfaces.srv._send_message import SendMessage_Response as Response
