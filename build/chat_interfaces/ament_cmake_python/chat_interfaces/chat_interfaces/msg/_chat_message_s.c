...
bool chat_interfaces__msg__chat_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("chat_interfaces.msg._chat_message.ChatMessage", full_classname_dest, 45) == 0);
  }
  chat_interfaces__msg__ChatMessage * ros_message = _ros_message;
  {  // sender
...
PyObject * chat_interfaces__msg__chat_message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("chat_interfaces.msg._chat_message");
