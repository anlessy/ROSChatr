...
static const _ChatMessage_type_support_symbol_names_t _ChatMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chat_interfaces, msg, ChatMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, chat_interfaces, msg, ChatMessage)),
  }
};
...
{
  return &::chat_interfaces::msg::rosidl_typesupport_cpp::ChatMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, chat_interfaces, msg, ChatMessage)() {
  return get_message_type_support_handle<chat_interfaces::msg::ChatMessage>();
}
