...
static const _ChatMessage_type_support_symbol_names_t _ChatMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chat_interfaces, msg, ChatMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chat_interfaces, msg, ChatMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, chat_interfaces, msg, ChatMessage)() {
  return &::chat_interfaces::msg::rosidl_typesupport_c::ChatMessage_message_type_support_handle;
}
