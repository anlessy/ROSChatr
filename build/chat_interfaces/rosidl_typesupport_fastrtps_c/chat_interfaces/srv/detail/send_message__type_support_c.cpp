...
#include "chat_interfaces/srv/detail/send_message__rosidl_typesupport_fastrtps_c.h"
...
#include "chat_interfaces/msg/detail/chat_message__functions.h"  // message
...
using _SendMessage_Request__ros_msg_type = chat_interfaces__srv__SendMessage_Request;
  ...
  // Field name: message
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, chat_interfaces, msg, ChatMessage
      )()->data);
...
size_t get_serialized_size_chat_interfaces__srv__SendMessage_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SendMessage_Request__ros_msg_type * ros_message = static_cast<const _SendMessage_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_chat_interfaces__msg__ChatMessage(
...
static uint32_t _SendMessage_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_chat_interfaces__srv__SendMessage_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_chat_interfaces
size_t max_serialized_size_chat_interfaces__srv__SendMessage_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: message
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_chat_interfaces__msg__ChatMessage(
  ...
  if (is_plain) {
    ...
    using DataType = chat_interfaces__srv__SendMessage_Request;
    is_plain =
      (
...
static size_t _SendMessage_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_chat_interfaces__srv__SendMessage_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chat_interfaces, srv, SendMessage_Request)() {
...
using _SendMessage_Response__ros_msg_type = chat_interfaces__srv__SendMessage_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_chat_interfaces
size_t get_serialized_size_chat_interfaces__srv__SendMessage_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SendMessage_Response__ros_msg_type * ros_message = static_cast<const _SendMessage_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_chat_interfaces__srv__SendMessage_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_chat_interfaces
size_t max_serialized_size_chat_interfaces__srv__SendMessage_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = chat_interfaces__srv__SendMessage_Response;
    is_plain =
      (
...
static size_t _SendMessage_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_chat_interfaces__srv__SendMessage_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chat_interfaces, srv, SendMessage_Response)() {
...
// already included above
// #include "chat_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "chat_interfaces/srv/send_message.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chat_interfaces, srv, SendMessage)() {
