...
#ifndef CHAT_INTERFACES__SRV__DETAIL__SEND_MESSAGE__FUNCTIONS_H_
#define CHAT_INTERFACES__SRV__DETAIL__SEND_MESSAGE__FUNCTIONS_H_
 ...
 * calls
 * chat_interfaces__srv__SendMessage_Request__init().
...
/**
 * It calls
 * chat_interfaces__srv__SendMessage_Request__fini()
 ...
 * chat_interfaces__srv__SendMessage_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * chat_interfaces__srv__SendMessage_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chat_interfaces__srv__SendMessage_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chat_interfaces
...
/**
 * It calls
 * chat_interfaces__srv__SendMessage_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chat_interfaces
...
/**
 * It allocates the memory for the array and calls
 * chat_interfaces__srv__SendMessage_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chat_interfaces
...
/**
 * It calls
 * chat_interfaces__srv__SendMessage_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CHAT_INTERFACES__SRV__DETAIL__SEND_MESSAGE__FUNCTIONS_H_
